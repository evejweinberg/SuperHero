function flapWin1(x, y, targetX, targetY) {
  this.x = x;
  this.y = y;
  this.xStatic = x;
  this.yStatic = y;
...
function flapWin2(x, y, targetX, targetY) {
  this.x = x;
  this.y = y;
  this.size = 50;
  this.linelength = 170;
